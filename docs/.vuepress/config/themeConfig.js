...
module.exports = {
  ...
  repo: 'https://gitee.com/china-fanxin/vuepress-blog/', // 导航栏右侧生成Github链接
  ...
  author: {
    ...
    name: 'Fanxin', // 必需
    link: 'https://gitee.com/china-fanxin', // 可选的
  },
  blogger: {
    // 博主信息，显示在首页侧边栏
  ...
  footer: {
    ...
    copyrightInfo:
      'Fan Xin | <a href="https://gitee.com/china-fanxin/vuepress-blog" target="_blank">Gitee repo</a>', // 博客版权信息，支持a标签
  },
