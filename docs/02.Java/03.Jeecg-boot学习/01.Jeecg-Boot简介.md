---
title: Jeecg-Boot简介
date: 2021-02-28 14:04:22
permalink: /pages/9c228e/
categories:
  - Jeecg-boot学习
tags:
  - 
...
看完之后是不是很心动？？正是因为发现了这个开源项目，所以我意识到了程序员未来的发展方向绝对是架构方向，普通的CRUD操作未来并不需要程序员来完成，随便找个人培训一下自动生成代码的软件操作流程，就可以快速完成类似于我们现在所谓的开发工作，给自己充电必须提上日程！！！

而且作为一个开源爱好者，这样一款优秀的开源项目已经深深的吸引了我！！！暂时有一个目标，希望在学习、使用 `Jeecg-boot` 三个月做的的时候，我可以加入到这个开源团队中，贡献自己的一份力量！！甚至如果有机会可以加入到这样的团队，潜心钻研架构技术！！！

这算是我立下的 flag 吧~~为了目标，Fighting！！！😎😎😎
